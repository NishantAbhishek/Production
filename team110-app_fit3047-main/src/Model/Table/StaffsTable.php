...
class StaffsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('staff_email')
            ->maxLength('staff_email', 254)
            ->requirePresence('staff_email', 'create')
            ->notEmptyString('staff_email')
            ->add('staff_email', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['staff_email']), ['errorField' => 'staff_email']);
